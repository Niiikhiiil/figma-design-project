    ...
    return (
        ...
        >
            <div className='flex items-center justify-center flex-col'>
                ...
                <div className="mb-5 relative flex items-center justify-between w-auto p-4 rounded-2xl bg-gradient-to-r from-indigo-400 to-purple-500 text-white font-semibold overflow-hidden">
                ...
                <div className="mb-5 flex items-center justify-around mx-auto gap-4">
                    {
                        [
                                ...
                                <div className='flex items-center justify-between gap-2'>
                                    {
                                        [...Array(stars?.stars)].map((star, subIndex) => (
                                            <img src={StarIcon} alt='star' width={24} height={24} key={subIndex} />
                                        ))
                                    }

                                    <div>{stars.stars}/5</div>
                                </div>
                            </div>
                        ))
                    }
                ...
                <div className="flex items-center justify-around mb-5 gap-5 flex-col md:flex-row">
                    <div className='flex items-center bg-[#373737] py-2.5 px-4 rounded-3xl justify-between gap-5 text-white w-full' >
                        <div className='flex-1 flex-col items-start'>
                            <div className='font-extralight'>Availble In</div>
                    ...
                    <div className='flex items-center text-xl justify-center py-2.5 px-6.5 rounded-3xl bg-[#B3FC6A] h-17 w-full'>
