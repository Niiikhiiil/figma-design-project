...
const JoinProffesional = () => {
    return (
        <section className=' flex items-center justify-center mt-10 relative bg-[#EAEFFA] p-5 my-5 mx-auto'>
            <div className='flex flex-col items-center justify-center gap-5 '>
                {/* Top Header */}
                <h1 className='text-xl md:text-2xl lg:text-4xl font-semibold text-[#090F4E] mt-6'>Join Thousands of Professionals Using LeadCRM</h1>
...
export default JoinProffesional